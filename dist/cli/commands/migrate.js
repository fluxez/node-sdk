    ...
    if (resolvedPath.endsWith('.ts')) {
        ...
        try {
            ...
            try {
                ...
                console.log(chalk_1.default.gray('You can install it with: npm install -D tsx'));
            }
        }
    }
...
function getApiConfig() {
    ...
    if (!apiKey) {
        console.error(chalk_1.default.red('❌ FLUXEZ_API_KEY not found!'));
...
async function runMigration(schemaPath, options) {
    ...
    const client = new index_1.FluxezClient(apiKey, {
        debug: options.verbose || false
    });
    try {
        console.log(chalk_1.default.blue('🚀 Fluxez Database Migration'));
        ...
        console.log(chalk_1.default.green(`✅ Ready to migrate\\n`));
