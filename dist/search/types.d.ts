export interface SearchQuery {
    query: string;
    fields?: string[];
    type?: 'match' | 'multi_match' | 'match_phrase' | 'term' | 'terms' | 'prefix' | 'wildcard' | 'fuzzy' | 'range' | 'bool' | 'more_like_this';
...
export interface AggregationQuery {
    field: string;
    type: 'terms' | 'sum' | 'avg' | 'min' | 'max' | 'count' | 'cardinality' | 'percentiles' | 'histogram' | 'date_histogram';
    size?: number;
