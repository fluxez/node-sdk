...
// It provides backward compatibility with the @appatonce/node-sdk package
...
const cliPath = isDev 
  ? path.join(__dirname, '..', 'src', 'migration', 'cli.ts')
  : path.join(__dirname, '..', 'dist', 'migration', 'cli.js');
