...
export class PaymentClient {
   ...
   * ```
   */
  async configureProvider(config: CreatePaymentConfigRequest): Promise<{ success: boolean }> {
    try {
   ...
   * @returns Success status
   */
  async updateConfig(updates: UpdatePaymentConfigRequest): Promise<{ success: boolean }> {
    try {
   ...
   */
  async createConfig(config: CreatePaymentConfigRequest): Promise<PaymentConfig> {
  ...
  async createCheckoutSession(
    ...
    try {
      ...
      const response = await this.httpClient.post<ApiResponse<{ url: string; sessionId: string }>>(
        `/tenant-payment/subscriptions`,
        data
      );
  ...
  async getSubscription(
    ...
    try {
      ...
      const response = await this.httpClient.get<ApiResponse<Subscription>>(
        `/tenant-payment/subscriptions/${subscriptionId}`
      );
   ...
   */
  async getActiveSubscriptionByMetadata(
    metadataKey: string,
    ...
    try {
      ...
      const response = await this.httpClient.get<Subscription>(url);
  ...
  async cancelSubscription(
    ...
    try {
      ...
      const response = await this.httpClient.delete<ApiResponse<Subscription>>(
        `/tenant-payment/subscriptions/${subscriptionId}`
      );
  ...
  async resumeSubscription(
    ...
    try {
      ...
      const response = await this.httpClient.post<ApiResponse<Subscription>>(
        `/tenant-payment/subscriptions/${subscriptionId}/resume`,
        {}
      );
  ...
  async createConnectAccount(
    ...
    try {
      ...
      const response = await this.httpClient.post<ApiResponse<{ accountId: string; onboardingUrl: string }>>(
        `/tenant-payment/connect/account`,
        businessInfo || {}
      );
   ...
   * ```
   */
  async getConnectOnboardingLink(): Promise<{ onboardingUrl: string }> {
    try {
      this.logger.debug('Getting Connect onboarding link');

      const response = await this.httpClient.get<ApiResponse<{ onboardingUrl: string }>>(
        `/tenant-payment/connect/onboarding`
      );
   ...
   * ```
   */
  async getConnectDashboardLink(): Promise<{ dashboardUrl: string }> {
    try {
      this.logger.debug('Getting Connect dashboard link');

      const response = await this.httpClient.get<ApiResponse<{ dashboardUrl: string }>>(
        `/tenant-payment/connect/dashboard`
      );
  ...
  async handleWebhook(
    ...
    try {
      ...
      const response = await this.httpClient.post<ApiResponse<{ processed: boolean; message?: string }>>(
        `/tenant-payment/${organizationId}/${projectId}/webhook`,
        payload,
        {
          headers: {
  ...
  async listPaymentMethods(
    ...
    try {
      ...
      const response = await this.httpClient.get<ApiResponse<PaymentMethod[]>>(
        `/tenant-payment/payment-methods?${params.toString()}`
      );
  ...
  async addPaymentMethod(
    ...
    try {
      ...
      const response = await this.httpClient.post<ApiResponse<PaymentMethod>>(
        `/tenant-payment/payment-methods`,
  ...
  async removePaymentMethod(
    ...
    try {
      ...
      const response = await this.httpClient.delete<ApiResponse<{ success: boolean }>>(
        `/tenant-payment/payment-methods/${paymentMethodId}`
      );
  ...
  async setDefaultPaymentMethod(
    ...
    try {
      ...
      const response = await this.httpClient.put<ApiResponse<{ success: boolean }>>(
        `/tenant-payment/payment-methods/${paymentMethodId}/default`,
        { userId }
      );
  ...
  async listInvoices(
    ...
    try {
      ...
      const response = await this.httpClient.get<ApiResponse<Invoice[]>>(
        `/tenant-payment/invoices?${params.toString()}`
      );
  ...
  async getInvoice(invoiceId: string): Promise<Invoice> {
    try {
      ...
      const response = await this.httpClient.get<ApiResponse<Invoice>>(
        `/tenant-payment/invoices/${invoiceId}`
      );
  ...
  async getUpcomingInvoice(userId: string): Promise<Invoice | null> {
    try {
      ...
      const response = await this.httpClient.get<ApiResponse<Invoice | null>>(
        `/tenant-payment/invoices/upcoming?userId=${userId}`
      );
...
// ============================================
// Type Definitions for Payment Methods & Invoices
// ============================================
